                        ...
                        <div class="team-card rounded-lg shadow-lg overflow-hidden transition duration-300 hover:-translate-y-1 hover:shadow-xl max-w-sm w-full">
                            <div class="p-6">
                                <div class="aspect-w-1 aspect-h-1 mb-4">
                                    <img class="w-full h-64 object-cover object-center rounded-lg" src="<?php echo e(asset('storage/' . $data->image)); ?>" alt="<?php echo e($data->name); ?>" />
                                </div>
                                <h4 class="text-xl font-semibold dark-mode-text text-center"><?php echo e($data->name); ?></h4>
                                <p class="text-md text-gray-600 dark:text-gray-300 text-center"><?php echo e($data->nim); ?></p>
                                <p class="mt-2 text-md text-gray-500 dark:text-gray-400 text-center"><?php echo e($data->prodi); ?></p>
                                <p class="text-md text-gray-600 dark:text-gray-300 text-center"><?php echo e($data->alamat); ?></p>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Users\Saidi\OneDrive\Desktop\uas-desainwebkelompok\resources\views/welcome.blade.php ENDPATH**/ ?>